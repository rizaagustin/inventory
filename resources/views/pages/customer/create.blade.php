    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('customer.store') }}" id="addForm">
                @csrf
                <div class="form-group">
                    <label>Name</label>
                    <input type="text" name="name" class="form-control" placeholder="customer" autocomplete="off">
        ...
        <div class="modal-footer">
            <button type="button" onclick="addCustomer();" class="btn btn-primary pull-left">Save</button>
